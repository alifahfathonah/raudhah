...
<div class="ui container">
	<div class="ui piled segment">
		...
		<div class="ui basic segment stackable center aligned middle aligned grid">
			...
			<div class="twelve wide column">
				<div class="ui middle aligned">
					<h2 class="ui header">
						KMI FORMULIR DATA PRIBADI CALON SANTRI/SANTRIWATI<br>
		...
		@if ($set->registration == false && Auth::id() == null)
		...
		@php 
		$data = Auth::user();
		$regstep = $data->regstep['stepreg'] 
		@endphp

		@include('pagesregistrant.parts.stepper')
		@if ($regstep == 2) @include('pagesregistrant.parts.regsteptwo') @endif
		@if ($regstep == 3) @include('pagesregistrant.parts.regstepthree') @endif
		@if ($regstep == 4) @include('pagesregistrant.parts.regstepfour') @endif
