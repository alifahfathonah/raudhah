<form class="ui form basic segment @if ($errors->any()) error @endif" method="POST" action="{{route('register.step.4')}}">
	...
	<div class="field">
		...
		<div class="field required">
			...
			<div class="fields">
				<div class="twelve wide field @error('fname') error @enderror">
					<input type="text" name="fname" class="uppercase-input" value="{{old('fname', '')}}" placeholder="Nama lengkap ayah kandung">
				</div>
		...
		<div class="field required @error('fadd') error @enderror">
			...
			<input type="text" name="fadd" class="uppercase-input" value="{{old('fadd', '')}}" placeholder="Nama jalan, nomor, lingkungan/wilayah domisili">
		</div>
		...
		<div class="two fields">
			<div class="field required @error('fphone') error @enderror">
				...
				<input type="text" name="fphone" class="phone-input" value="{{old('fphone', '')}}" placeholder="Nomor telepon yang dapat dihubungi">
			</div>
			<div class="field">
				<label>Nomor WhatsApp</label>
				<input type="text" name="fwa" class="phone-input" value="{{old('fwa', '')}}" placeholder="Kosongkan jika tidak ada">
			</div>
		</div>
		...
		<div class="fields">
			<div class="seven wide field required @error('fktp') error @enderror">
				...
				<input type="text" name="fktp" class="digit-input" value="{{old('fktp', '')}}" placeholder="16 digit nomor KTP ayah">
			</div>
			<div class="three wide field required">
				<label>Pendidikan Terakhir</label>
				<select name="fedu" class="ui dropdown">
					@foreach ($edulevels as $fedu)
					<option value="{{$fedu}}"{{old('fedu') == $fedu ? ' selected' : $fedu == 'SMA' ? ' selected' : ''}}>{{$fedu}}</option>
					@endforeach
				</select>
			</div>
			<div class="three wide field required">
		...
		<div class="three fields">
			...
			<div class="field required @error('fsal') error @enderror">
				...
				<div class="ui labeled input">
					...
					<input type="text" name="fsal" class="currency-input" value="{{old('fsal', '')}}" placeholder="Kisaran atau rata-rata">
				</div>
			</div>
			<div class="field">
				...
				<div class="ui labeled input">
					<div class="ui basic label">Rp.</div>
					<input type="text" name="faddsal" class="currency-input" value="{{old('faddsal', '')}}" placeholder="Kosongkan jika tidak ada">
				</div>
			</div>
		</div>
		...
		<div class="field required">
			...
			<div class="fields">
				<div class="twelve wide field required @error('mname') error @enderror">
					<input type="text" name="mname" class="uppercase-input" value="{{old('mname', '')}}" placeholder="Nama lengkap ibu kandung">
				</div>
				<div class="four wide field required">
		...
		<div class="field" id="form-serumah">
			...
			<div class="field required @error('madd') error @enderror">
				<label>Alamat Lengkap</label>
				<input type="text" name="madd" class="uppercase-input" value="{{old('madd', '')}}" placeholder="Nama jalan, nomor, lingkungan/wilayah domisili">
			</div>
		...
		<div class="two fields">
			<div class="field required @error('mphone') error @enderror">
				<label>Nomor Telepon/HP</label>
				<input type="text" name="mphone" class="phone-input" value="{{old('mphone', '')}}" placeholder="Nomor telepon yang dapat dihubungi">
			</div>
			<div class="field">
				<label>Nomor WhatsApp</label>
				<input type="text" name="mwa" class="phone-input" value="{{old('mwa', '')}}" placeholder="Kosongkan jika tidak ada">
			</div>
		</div>
		...
		<div class="fields">
			<div class="eight wide field required @error('mktp') error @enderror">
				<label>Nomor KTP</label>
				<input type="text" name="mktp" class="digit-input" value="{{old('mktp', '')}}" placeholder="16 digit nomor KTP ibu">
			</div>
			<div class="four wide field required">
				<label>Pendidikan Terakhir</label>
				<select name="medu" class="ui dropdown">
					@foreach ($edulevels as $medu)
					<option value="{{$medu}}"{{old('medu') == $medu ? ' selected' : $medu == 'SMA' ? ' selected' : ''}}>{{$medu}}</option>
					@endforeach
				</select>
			</div>
			<div class="four wide field required">
		...
		<div class="three fields">
			...
			<div class="field required @error('msal') error @enderror">
				...
				<div class="ui labeled input">
					<div class="ui basic label">Rp.</div>
					<input type="text" name="msal" class="currency-input" value="{{old('msal', '')}}" placeholder="Kisaran atau rata-rata">
				</div>
			</div>
			<div class="field">
				<label>Penghasilan Tambahan</label>
				<div class="ui labeled input">
					<div class="ui basic label">Rp.</div>
					<input type="text" name="maddsal" class="currency-input" value="{{old('maddsal', '')}}" placeholder="Kosongkan jika tidak ada">
				</div>
			</div>
		</div>
	...
	<div class="field" id="form-pembiaya">
		...
		<div class="fields">
			<div class="eight wide field required @error('donaturname') error @enderror">
				...
				<input type="text" name="donaturname" class="uppercase-input" value="{{old('donaturname', '')}}" placeholder="Nama lengkap yang membiayai">
			</div>
			<div class="four wide field required">
			...
			<div class="four wide field required @error('donaturphone') error @enderror">
				...
				<input type="text" name="donaturphone" class="phone-input" value="{{old('donaturphone', '')}}" placeholder="Nomor telepon yang dapat dihubungi">
			</div>
		</div>
		
		<div class="field required @error('donaturadd') error @enderror">
			<label>Alamat Lengkap</label>
			<input type="text" name="donaturadd" class="uppercase-input" value="{{old('donaturadd', '')}}" placeholder="Nama jalan, nomor, lingkungan/wilayah domisili">
		</div>
